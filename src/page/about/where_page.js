    ...
    <div>
      ...
      <section className="pb-24">
        <div className=" flex flex-col justify-center items-start lg:px-24 px-12 lg:pt-24 pt-12 text-white">
          <div className="flex flex-row justify-between items-center gap-8 w-full bg-[#092040] rounded-2xl">
            <div className="w-2/5 h-full">
              <img src={LippoThamrin} alt="" className="rounded-l-2xl aspect-4/3 object-cover"/>
            </div>
            <div className="pr-12">
