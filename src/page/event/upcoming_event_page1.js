  ...
  return (
    <div>
      ...
      <section className="w-full h-full">
        ...
        <div className="w-full h-5/6 top-0 absolute flex flex-col justify-center p-24 items-center">
          <div className="  p-8 flex flex-col justify-center items-center rounded-2xl">
            <p className="text-white font-bold text-5xl mb-12">Transformational Sales Conference</p>
            <p className="text-white font-bold text-2xl">10 AGUSTUS 2024</p>
            <p className="text-white font-light text-xl">MENARA DANAREKSA (ARYA NUSA BALLROOM)</p>
            <p className="text-white font-light text-xl">JAKARTA</p>
            <div className="flex flex-row gap-8 mt-12">
              <Link to="/event/register-event">
                <button className="bg-[#005F94] h-12 w-32 text-white font-bold rounded-full text-sm">REGISTER</button>
              </Link>
              <button className="bg-[#005F94] h-12 w-32 text-white font-bold rounded-full text-sm">LEARN MORE</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="flex flex-col mt-12 justify-center items-center">
        ...
        <p className="text-4xl mb-12 font-medium">Transformational Sales Conference 2024</p>
        <img src={TransformationalSalesConference} alt="" className="w-3/5 aspect-16/9 bg-center bg-cover top-14" />
        <div className="mx-24 flex flex-col justify-center items-center my-24">
          ...
          <div className="flex flex-row mx-12">
            ...
            <p className="text-justify font-light">
              <span>"Don't find customers for your products, find products for your customers." ~ Seth Godin</span>
              <br />
              <br /> Discover the future of sales at our upcoming conference, "From Transaction to Transformation: The New Sales Paradigm." Join us for dynamic keynote presentations, interactive workshops, engaging panel discussions, and an
              exhibitor showcase featuring the latest tools and technologies. Learn from industry experts, connect with like-minded professionals, and gain actionable strategies to thrive in today's evolving sales landscape. Don't miss out
              on this transformative experience – register now to secure your spot!
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#C3D21F] flex flex-col rounded-t-[100px] py-24">
        <div className="flex flex-col items-center justify-center">
          <p className="text-xl mb-12 font-light underline underline-offset-2">The Speakers</p>
      ...
      <section className="bg-[#C3D21F] flex flex-col">
        <div className="flex flex-col items-center justify-center bg-[#F2EEEA] rounded-t-[100px] py-24">
          ...
          <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-1">
            {posts.map((post) => (
              <article key={post.id} className="flex max-w-6xl flex-col items-start justify-between">
                <div className="flex flex-row justify-center items-start">
                  ...
                  <div>
                    ...
                    <div className="text-sm leading-6 mt-8 flex flex-row w-full items-center justify-between">
                      <NavLink to={`/event/${post.id}`} className="bg-[#195A94] text-white px-8 py-2 rounded-xl">
                        Look up the event
                      </NavLink>
                    </div>
                  </div>
...
export default UpcomingEventPage1;
